export default function Hero() {
  return (
    <section id="home" className="bg-[#fa6a21]">
      <div className="mx-auto grid min-h-[60vh] max-w-[1180px] items-center px-6 pb-25 pt-[70px] max-[860px]:min-h-0 max-[860px]:pt-[34px]">
        <div className="grid grid-cols-[minmax(320px,1fr)_minmax(320px,500px)] items-center gap-[34px] max-[860px]:grid-cols-1">
          <div>
            <h1 className="text-[70px] font-black leading-[1.05] tracking-[0.4px] text-white">
              THE FUTURE OF
              <br />
              REAL ESTATE
              <br />
            ...
            <p className="mt-[42px] max-w-[460px] text-[35px] leading-[1.25] text-[#ffe2d0] max-[1100px]:text-[22px]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to bottom, rgba(255,125,53,0.08), rgba(0,0,0,0.25)), url('/skyline.jpg')"
        }}
      />
    </section>
  )
